...
export const siteSettingsType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      group: "company",
      fields: [
        defineField({ name: "phone", title: "Sales phone (display)", type: "string" }),
        defineField({ name: "phoneRaw", title: "Sales phone (tel: link)", type: "string" }),
        defineField({ name: "servicePhone", title: "Service phone (display)", type: "string" }),
        defineField({ name: "servicePhoneRaw", title: "Service phone (tel: link)", type: "string" }),
