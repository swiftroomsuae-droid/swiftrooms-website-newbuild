...
const DEFAULTS: SiteSettings = {
  contact: {
    phone: "04 347 4240",
    phoneRaw: "+97143474240",
    servicePhone: "04 323 1625",
    servicePhoneRaw: "+97143231625",
    email: "hello@swiftrooms.ae",
    whatsapp: "971505269149",
  },
  showroom: {
    addressLine1: "ET JAR - J1 Complex, Block A, Warehouse 11-12",
    addressLine2: "Jebel Ali, Ind Area 1",
    city: "Dubai",
    country: "UAE",
    hours: [
  ...
  factory: {
    addressLine1: "Dubai Real Estate Centre Ind Park, Unit 1-B",
    addressLine2: "Jebel Ali, Ind Area 1",
    city: "Dubai",
    country: "UAE",
    phone: "04 323 1625",
    phoneRaw: "+97143231625",
  },
  footerLinks: [
    {
      heading: "Products",
...
const QUERY = groq`*[_id == "siteSettings"][0]{ contact, showroom, factory, footerLinks, social, footer, navigation, cta }`;

type RawSettings = Partial<{
  contact: Partial<SiteSettings["contact"]>;
  showroom: Partial<SiteSettings["showroom"]>;
  factory: Partial<SiteSettings["factory"]>;
  ...
  try {
    ...
    return {
      contact: {
        ...
        servicePhone: d.contact?.servicePhone || DEFAULTS.contact.servicePhone,
        servicePhoneRaw: stegaClean(d.contact?.servicePhoneRaw || DEFAULTS.contact.servicePhoneRaw),
