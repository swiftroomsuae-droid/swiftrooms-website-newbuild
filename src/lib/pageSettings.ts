...
// Fallback OG/Twitter image used whenever a page's own metadata and Sanity's
// pageSettings.seo.openGraphImage both leave it unset — every page needs
// SOME og:image, not a missing tag.
