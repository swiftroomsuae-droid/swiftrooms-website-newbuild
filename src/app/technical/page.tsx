              ...
              <ScrollReveal key={section.href} delay={i * 0.08}>
                ...
                >
                  ...
                  <div className="p-6 md:p-8 lg:p-10">
                    ...
                    <p className="text-xl md:text-2xl font-semibold text-[#1c1c1e] mb-3 group-hover:text-[#007969] transition-colors">
                      {section.title}
                    </p>
              ...
              <ScrollReveal key={post.slug} delay={i * 0.08}>
                ...
                >
                  ...
                  <div className="p-5 md:p-6">
                    ...
                    <p className="font-semibold text-[#1c1c1e] mb-2 group-hover:text-[#007969] transition-colors leading-snug">
                      {post.title}
                    </p>
