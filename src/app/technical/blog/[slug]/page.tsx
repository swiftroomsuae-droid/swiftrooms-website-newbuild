...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `${SITE_URL}/technical/blog/${post.slug}` },
    openGraph: {
      type: "article",
      title: post.title,
      description: post.excerpt,
      url: `${SITE_URL}/technical/blog/${post.slug}`,
      images: [
        post.image
          ? { url: post.image, alt: post.title }
          : { url: `${SITE_URL}/brand/og-default.jpg`, width: 1200, height: 630, alt: post.title },
      ],
...
export default async function BlogPostPage({ params }: Props) {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `${SITE_URL}/technical/blog/${post.slug}`,
    },
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Technical Hub", item: `${SITE_URL}/technical` },
      { "@type": "ListItem", position: 3, name: "Blog & Insights", item: `${SITE_URL}/technical/blog` },
      { "@type": "ListItem", position: 4, name: post.title, item: `${SITE_URL}/technical/blog/${post.slug}` },
    ],
  };
                ...
                <ScrollReveal key={rel.slug} delay={i * 0.08}>
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-[#1c1c1e] font-semibold leading-snug group-hover:text-[#007969] transition-colors mb-2">
                        {rel.title}
                      </p>
