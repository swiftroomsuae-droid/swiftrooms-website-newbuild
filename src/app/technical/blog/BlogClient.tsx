                ...
                <ScrollReveal>
                  ...
                  >
                    ...
                    <div className="p-7 md:p-10 lg:p-14 flex flex-col justify-center flex-1">
                      ...
                      <p className="text-xl md:text-2xl lg:text-3xl font-semibold text-[#1c1c1e] mb-4 leading-snug group-hover:text-[#007969] transition-colors max-w-lg">
                        {filtered[0].title}
                      </p>
                    ...
                    <ScrollReveal key={post.slug} delay={i * 0.06}>
                      ...
                      >
                        ...
                        <div className="p-5 sm:p-8 flex flex-col flex-1">
                          ...
                          <p className="text-[#1c1c1e] font-semibold mb-3 leading-snug flex-1 group-hover:text-[#007969] transition-colors">
                            {post.title}
                          </p>
