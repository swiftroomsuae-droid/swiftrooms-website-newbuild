              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
                <div className="flex items-end justify-between gap-4">
                  <div>
                    ...
                    <p className="text-2xl md:text-4xl font-semibold text-white mb-1">{featured.name}</p>
                      ...
                      >
                        ...
                        <div className="p-4 md:p-5">
                          <div className="flex items-start justify-between mb-1.5">
                            <p className="text-[#1c1c1e] font-semibold text-sm md:text-base group-hover:text-[#007969] transition-colors">
                              {project.name}
                            </p>
          ...
          <>
            ...
            >
              <div className="flex items-center justify-between px-5 pt-5 pb-4 border-b border-gray-100 sticky top-0 bg-white">
                <p className="font-semibold text-[#1c1c1e]">Filter Projects</p>
                <button
                  onClick={() => setFilterDrawerOpen(false)}
