...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        ogImage
          ? { url: ogImage, alt: project.name }
          : { url: `${SITE_URL}/brand/og-default.jpg`, width: 1200, height: 630, alt: project.name },
      ],
    },
  };
}
            ...
            <div className="lg:col-span-2">
              ...
              <ScrollReveal>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-3">
                  {project.productLinks.map((product) => (
                    <Link key={product.href} href={product.href} className="group block">
                      <div className="flex items-center gap-3 border border-gray-100 p-3 md:p-4 bg-[#f8f9fa] group-hover:border-[#007969] transition-colors">
                        ...
                        <span className="text-[#3a3a3c] text-sm flex-1">{product.name}</span>
