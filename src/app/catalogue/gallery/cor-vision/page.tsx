...
const baseMetadata: Metadata = {
  ...
  alternates: { canonical: `${SITE_URL}/catalogue/gallery/cor-vision` },
  openGraph: {
    ...
    url: `${SITE_URL}/catalogue/gallery/cor-vision`,
...
export default async function CorVisionGalleryPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: "Cor Vision Gallery", item: `${base}/catalogue/gallery/cor-vision` },
    ],
  };
            ...
            {[
              ...
              <ScrollReveal key={g.slug}>
                <Link href={`/catalogue/gallery/${g.slug}`} className="group block bg-white overflow-hidden">
                  ...
                  <div className="p-6">
                    <p className="font-semibold text-[#1c1c1e] group-hover:text-[#007969] transition-colors">{g.name}</p>
