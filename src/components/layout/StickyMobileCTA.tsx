...
export default function StickyMobileCTA() {
  ...
  return (
    <>
      {/* Spacer keeps the fixed bar from covering the bottom of the page (footer)
          on mobile. Rendered only where the bar is shown (this component returns
          null on /enquire & /showroom). */}
      <div
        aria-hidden
        className="lg:hidden"
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-gray-100 px-3 py-3 flex gap-2 shadow-[0_-4px_24px_rgba(0,0,0,0.10)] safe-bottom">
        ...
        <a
          ...
          className="flex items-center justify-center w-12 bg-[#25D366] flex-shrink-0"
          aria-label="WhatsApp"
        >
        ...
        <ShowroomButton className="flex-1 btn-outline justify-center py-3 px-2! text-[0.75rem]">
          Showroom
        </ShowroomButton>
      </div>
    </>
