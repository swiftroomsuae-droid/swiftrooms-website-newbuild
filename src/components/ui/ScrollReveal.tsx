...
export default function ScrollReveal({ children, delay = 0, direction = "up", className }: Props) {
  ...
  // Positive bottom margin starts the reveal slightly before the section
  // scrolls into view, so the fade finishes before it's actually visible —
  // a negative margin here left a real window where content had scrolled
  // into sight but hadn't faded in yet, reading as a blank gap.
